...
class DB:
    ...
    def insert(self,table,data, commit: bool = True, ignore_insert=False, replace_insert = False):
        cols = ",".join(data.keys())
        ...
        if ignore_insert:
            ...
            insert_option = "OR REPLACE"
        
        sql = f"INSERT {insert_option} INTO {table} ({cols}) VALUES ({placeholder})"
